...
public class Doctor {
    // --- Fields to match the data in Firebase ---
    ...
    // A default empty constructor is required for Firebase to deserialize the object
    public Doctor() {
    }

    // Constructor to create a new Doctor object with all details
    ...
    // These are required for Firebase to access the data
